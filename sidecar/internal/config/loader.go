...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("retrieval.entity_consolidation", false) // deterministic entity-anchored retrieval; env-bindable
	v.SetDefault("retrieval.llm_rerank_fallback", false)  // uncapped LLM-as-judge rerank fallback (cost/DoS guard); env-bindable
