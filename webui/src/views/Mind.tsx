...
// Mind — the consolidated "what Hygur knows about you" hub. Its header makes the
// feedback loop explicit: a gauge that grows as the user confirms/corrects, with a
// one-line invitation. The tabs mount the existing self-contained views unchanged;
// their per-item actions feed the gauge (it polls /insights/learning-progress).
